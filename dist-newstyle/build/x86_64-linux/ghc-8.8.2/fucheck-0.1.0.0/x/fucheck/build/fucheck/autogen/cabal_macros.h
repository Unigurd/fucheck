...
/* package fucheck-0.1.0.0 */
#ifndef VERSION_fucheck
#define VERSION_fucheck "0.1.0.0"
#endif /* VERSION_fucheck */
#ifndef MIN_VERSION_fucheck
#define MIN_VERSION_fucheck(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_fucheck */
...
#define CURRENT_COMPONENT_ID "fucheck-0.1.0.0-inplace-fucheck"
